...
class Mamifero(Animal):
    def __init__(self, peso: float, idade: int, membros: int, tem_pelo: bool = True, cor: str = 'caramelo') -> None:
...
class Cachorro(Mamifero):
    def __init__(self, nome: str, raca: str, peso: float, idade: int, membros: int, tem_pelo: bool, cor: str) -> None:
    ...
    def _emitir(self) -> str:
        return f'{self.nome.title()} está latindo'

    def _fazer_festa(self, pessoa: str = 'mim') -> str:
        return f'{self.nome.title()} está fazendo muita festa para {pessoa}!'
